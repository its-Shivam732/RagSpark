...
The result metrics are implemented using an audit log approach. To view details, refer directly to the - [Results/Audit Logs](#-resultsaudit-logs) , Alternatively, you can navigate through the Table of Contents in sequence to understand the complete architectural flow I followed. Toward the end, you’ll reach the Results section — this approach helps you fully grasp how the results were generated.
